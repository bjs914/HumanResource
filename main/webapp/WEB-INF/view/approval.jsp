...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">결재 현황</a>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">결재 현황 탭</h1>
      <p class="lead">결재 현황탭입니다.</p>
    </header>
...
<img class="card-img-top" src="http://placehold.it/500x325" alt="">
          ...
          <div class="card-footer">
            <a href="hr/vacation" class="btn btn-primary">결재신청</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="hr/approval" class="btn btn-primary">결재 목록</a>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-4">
