...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">휴가신청 및 결재현황</a>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">휴가관리 탭</h1>
      <p class="lead">휴가관리탭입니다.</p>
    </header>
    ...
    <div class="row text-center">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="hr/vacation" class="btn btn-primary">휴가신청</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="hr/approval" class="btn btn-primary">결재현황</a>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mb-4">
